...
def test_digitConverter() :
	converter = digitconverter.DigitConverter()
	converter._data = '01234567890'
	...
	assert noteGroupList[2].getNoteList()[0].getDuration() == constants.duration4th
	...
	assert noteGroupList[4].getNoteList()[0].getDuration() == constants.duration4th
	...
	assert noteGroupList[8].getNoteList()[0].getSpnName() == 'D5'
	assert noteGroupList[8].getNoteList()[0].getDuration() == constants.duration2nd
